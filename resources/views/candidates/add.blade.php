        ...
        <div class="card-body">
            ...
            <form method="post" enctype="multipart/form-data" action="{{route('candidates.insert')}}" accept-charset="utf-8">
                ...
                <div class="form-group col-md-8">
                    ...
                    <input type="file" id="image" name="image" accept="image/*" placeholder="Candidate image" class="form-control col-md-6" />
...
{{--End Of New Update--}}
            ...
            <div id="CandidateUploadDocument" class="tabcontent">
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="file" id="uploadDoc" name="uploadAttachment" accept="*" placeholder="Candidate Attachment" class="form-control col-md-8" />
